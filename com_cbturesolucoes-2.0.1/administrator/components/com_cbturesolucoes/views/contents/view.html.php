...
/**
 * View class for a list of Cbturesolucoes.
 *
 * @since  1.6
 */
class CbturesolucoesViewContents extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		CbturesolucoesHelper::addSubmenu('contents');
	...
	protected function addToolbar()
	{
		...
		$canDo = CbturesolucoesHelper::getActions();

		JToolBarHelper::title(JText::_('COM_CBTURESOLUCOES_TITLE_CONTENTS'), 'contents.png');
		...
		{
			JToolBarHelper::preferences('com_cbturesolucoes');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_cbturesolucoes&view=contents');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`created_by`' => JText::_('COM_CBTURESOLUCOES_CONTENTS_CREATED_BY'),
			'a.`modified_by`' => JText::_('COM_CBTURESOLUCOES_CONTENTS_MODIFIED_BY'),
			'a.`diretoria`' => JText::_('COM_CBTURESOLUCOES_CONTENTS_DIRETORIA'),
			'a.`ano`' => JText::_('COM_CBTURESOLUCOES_CONTENTS_ANO'),
			'a.`numresolucao`' => JText::_('COM_CBTURESOLUCOES_CONTENTS_NUMRESOLUCAO'),
			'a.`dataresolucao`' => JText::_('COM_CBTURESOLUCOES_CONTENTS_DATARESOLUCAO'),
			'a.`assunto`' => JText::_('COM_CBTURESOLUCOES_CONTENTS_ASSUNTO'),
			'a.`resolucao`' => JText::_('COM_CBTURESOLUCOES_CONTENTS_RESOLUCAO'),
		);
	}
