 ...
 * @since  1.6
 */
class CbtumaisdestaquesModelContent extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_cbtumaisdestaques')) && (!$user->authorise('core.edit', 'com_cbtumaisdestaques')))
		{
		...
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
				...
				if ($published = $this->getState('filter.published'))
				{
					...
					{
						throw new Exception(JText::_('COM_CBTUMAISDESTAQUES_ITEM_NOT_LOADED'), 403);
					}
				}
