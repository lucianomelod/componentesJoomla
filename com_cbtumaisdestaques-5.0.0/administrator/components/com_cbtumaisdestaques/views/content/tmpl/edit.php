...
$document->addStyleSheet(JUri::root() . 'media/com_cbtumaisdestaques/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_cbtumaisdestaques&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="content-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_CBTUMAISDESTAQUES_TITLE_CONTENT', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('modified_by'); ?>				<input type="hidden" name="jform[title]" value="<?php echo $this->item->title; ?>" />
