...
/**
 * View class for a list of Cbtumaisdestaques.
 *
 * @since  1.6
 */
class CbtumaisdestaquesViewContents extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		CbtumaisdestaquesHelper::addSubmenu('contents');
	...
	protected function addToolbar()
	{
		...
		$canDo = CbtumaisdestaquesHelper::getActions();

		JToolBarHelper::title(JText::_('COM_CBTUMAISDESTAQUES_TITLE_CONTENTS'), 'contents.png');
		...
		{
			JToolBarHelper::preferences('com_cbtumaisdestaques');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_cbtumaisdestaques&view=contents');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_CBTUMAISDESTAQUES_CONTENTS_TITLE'),
			'a.`catid`' => JText::_('COM_CBTUMAISDESTAQUES_CONTENTS_CATID'),
			'a.`created`' => JText::_('COM_CBTUMAISDESTAQUES_CONTENTS_CREATED'),
		);
	}
