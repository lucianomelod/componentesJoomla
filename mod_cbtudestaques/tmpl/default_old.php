						...
						<ul>
							...
							<li>
								...
								<div class="news-center-img">
									...
									<a href="<?php echo JURI::root(); ?>index.php?option=com_content&view=article&id=<?php echo $featured->id; ?>&itemid=<?php echo $itemid_menu; ?>"><?php if ($images["image_intro"] != null) { ?><img src="<?php echo JURI::root() . $images["image_intro"]; ?>"><?php } else { ?><img src="<?php echo JURI::root() . $img_default ?>"><?php } ?></a>
								</div>
								<div class="news-center-read-more">
									<a href="<?php echo JURI::root(); ?>index.php?option=com_content&view=article&id=<?php echo $featured->id; ?>&itemid=<?php echo $itemid_menu; ?>">Ver Notícia</a>
								</div>
